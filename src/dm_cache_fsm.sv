    ...
    always @(*) begin
        ...
        case (rstate)
            ...
            COMPARE_TAG: begin
                if (hit) begin
                    ...
                    if (cpu_req.rw == 1'b0) begin
                        // HIT de Leitura: Extrair a palavra correta do bloco (128 bits -> 32 bits)
                        // Lógica simplificada: usa o offset para escolher a palavra
            ...
            WRITE_BACK: begin
                ...
                // O endereço na memória junta a Tag ANTIGA com o Index atual
            ...
            ALLOCATE: begin
                ...
                // Pede o endereço que a CPU originalmente solicitou
